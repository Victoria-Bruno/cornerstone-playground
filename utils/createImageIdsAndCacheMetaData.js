...
export default async function createImageIdsAndCacheMetaData({
  ...
  const INSTANCE_CREATION_TIME = "00080031";
  const ACQUISITION_TIME = "00080032";
  const HOSPITAL_NAME = "07A31024";
  ...
  // const instanceCreationTime = instances[0][INSTANCE_CREATION_TIME];
  // const acquisitionTime = instances[0][ACQUISITION_TIME];
  // let hospitalName = instances[0][HOSPITAL_NAME];

  // let displayTime = "";
  // let sliceThickness = instances[0][SLICE_THICKNESS];

  // if (instanceCreationTime) {
  //   displayTime = instanceCreationTime.Value[0];
  // }

  // if (acquisitionTime && displayTime === "") {
  //   displayTime = acquisitionTime.Value[0];
  // }

  // if (hospitalName) {
  //   hospitalName = hospitalName.Value[0];
  // } else {
  //   hospitalName = "";
  // }

  // if (sliceThickness) {
  //   sliceThickness = sliceThickness.Value[0];
  // } else {
  //   sliceThickness = "";
  // }
